...
function InterviewCard({ interviewId, userId, role, type, techstack, createdAt, feedback = null }: InterviewCardProps) {
        ...
        <div className='card-interview'>
            ...
            <p className="badge-text ">{normalizedType}</p>
                ...
                <p className='line-clamp-2 mt-5'>
                    {feedback?.finalAssessment || 'You Have`t taken any interview yet . Take it now the improve your skills '}
                </p>
